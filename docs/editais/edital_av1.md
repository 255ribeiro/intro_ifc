...
1. A modelagem deve ser dividida em alguns arquivos:
   1. Um arquivo template deve ser ajustado e utilizado como base para todas as modelagens
   2. estrutura: contendo vigas pilares e lages.
   3. arquitetura pavimento térreo: contendo paredes, portas, janelas e forros do referido pavimento.
   4. arquitetura do pavimento superior: contendo paredes, portas, janelas e forros do referido pavimento. 
   5. cobertura com estrutura e calhas (apenas para equipes com 4 integrantes).
2. Os arquivos devem ser modelados em metros.
3. A escada pode ser modelada no arquivo estrutura.
...
1. Arquivos com os modelos BIM em formato IFC e o formato nativo do programa de autoria
   1. Arquivo template
   2. Arquivo de estruturas
   3. arquitetura do pav térreo
   4. arquitetura do primeiro pavimento
   5. cobertura com estrutura e calhas (apenas para equipes com 4 integrantes).
